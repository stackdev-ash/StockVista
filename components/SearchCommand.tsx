    ...
    <>
      {renderAs === "text" ? (
        ...
        <Button
          ...
          className="px-4 py-2 text-base h-10 font-semibold rounded-lg bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 hover:bg-cyan-500/20 transition-all duration-200"
        >
          {label}
        </Button>
      )}
